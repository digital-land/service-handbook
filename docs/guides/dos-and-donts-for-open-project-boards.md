...
- **Don't comment on individuals or organisations in an objectionable way.** You're representing MHCLG and the department, so don't say anything that would bring our work into disrepute. (You can share grumbles and opinions in a safer, closed space like team meetings.)
- **Be clear, give context.** Your team-mates need clarity to be effective. You may only need to neuter your words if there's a security risk, privacy risk, policy risk, or a delicate relationship to maintain.
- **If you're working on something that's already mentioned in the public domain, you can talk about it openly.** Just make sure to follow the other dos and don'ts. Ask a policy colleague if in doubt, as they will have to deal with any accidental disclosures.
- **Add issues to a private repo if anything must remain hidden.** A GitHub project board can show issues from multiple repositories. You can add issues to a private repo if needs be, and this will keep information hidden. It's probably sensible to keep policy-related matters in access-controlled documents and emails, to protect against leaks or premature disclosure.
- **You can still make mistakes.** We know that no one is perfect and new ways of working can take time to get used to. You probably won't make any big mistakes or release confidential information, but ask your service owner or a policy colleague if unsure.